...
#         self.drawOneLine(dates, shuihuo_scores, '水火')
#         self.drawOneLine(dates, jinmu_scores, '金木')
#         self.drawOneLine(dates, pfh, '综合能量')
...
#         self.figs.canvas.flush_events()
#
#     def drawOneLine(self, dates, data, label):
#         self.axes.plot(dates, data, label=label)
#
#     def clean(self):
#         self.axes.cla()
#
